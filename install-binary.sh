...
# borrowed with love from https://github.com/technosophos/helm-template

PROJECT_NAME="helm-scaffold"
PROJECT_GH="danryan/$PROJECT_NAME"

: ${HELM_PLUGIN_PATH:="$(helm home)/plugins/helm-scaffold"}
...
installFile() {
  ...
  HELM_TMP_BIN="$HELM_TMP/scaffold"
